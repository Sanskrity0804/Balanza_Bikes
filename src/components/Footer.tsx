...
// import { Instagram, Facebook, Twitter, Send, Phone, Mail, Clock, Youtube } from 'lucide-react';
...
//               <a href="https://www.instagram.com/balanzabikes?igsh=NjB4dnl1eWszcW5o&utm_source=qr" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white transition-all cursor-pointer shadow-sm" title="Instagram">
...
//               </a>
//               <a href="https://www.youtube.com/@BalanzaBikes" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white transition-all cursor-pointer shadow-sm" title="YouTube">
...
import React from 'react';
import { Instagram, Facebook, Twitter, Youtube, Phone, Mail, Clock } from 'lucide-react';
import BalanzaLogo from './BalanzaLogo';
import { useApp } from '../context/AppContext';
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white transition-all cursor-pointer shadow-sm" title="YouTube">
                <Youtube className="h-4 w-4" />
              </a>
            </div>
          </div>
