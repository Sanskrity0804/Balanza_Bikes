...
//         <div 
//           id="login-modal-box"
//           className="relative w-full max-w-[1050px] flex flex-col md:flex-row gap-6 transition-all duration-500 scale-100 z-10 h-[620px] max-h-[85vh] items-stretch"
//         >
//           {/* LEFT SIDEBAR CARD */}
//           <div className="w-full md:w-[280px] bg-white rounded-3xl border border-slate-100 p-6 flex flex-col justify-between shrink-0 shadow-2xl h-full relative">
//             <div>
//               {/* Brand Logo inside Sidebar - Styled with Neon Green logo/text on dark slate background */}
//               <div className="mb-6 -mx-6 -mt-6 p-5 rounded-t-3xl bg-slate-950 border-b border-[#A7E22E]/20 flex justify-center shadow-md">
//                 <BalanzaLogo className="h-10 w-auto text-[#A7E22E]" showIcon={true} />
//               </div>

//               {/* User avatar and email info */}
//               <div className="flex items-center gap-3.5 mb-8 p-3 bg-[#A7E22E]/5 rounded-xl border border-[#A7E22E]/20 select-text">
//                 <div className="h-12 w-12 rounded-full bg-slate-950 text-[#A7E22E] border-2 border-[#A7E22E] font-sans text-base font-black flex items-center justify-center shadow-md shrink-0">
...
//                         <Icon className={`h-4.5 w-4.5 stroke-[2] ${isActive ? 'text-slate-950' : 'text-slate-400'}`} />
...
//           <div className="flex-1 bg-white border border-slate-100 rounded-3xl p-8 shadow-2xl overflow-y-auto h-full flex flex-col justify-between relative">
//               <div>
...
//                         <h4 className="font-display text-xs font-black uppercase text-slate-800 tracking-wide mb-3">
...
//                                 className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-bold text-slate-700 focus:outline-none focus:border-slate-900"
//                               >
...
//                             </div>
//                             <div>
//                               <label className="block text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Pincode</label>
//                               <input
//                                 type="text"
//                                 required
//                                 pattern="[0-9]{6}"
...
//                           <div>
//                             <label className="block text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Street Address</label>
//                             <textarea
//                               required
//                               rows={2}
//                               value={addressStreet}
...
//                               className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-semibold text-slate-700 focus:outline-none focus:border-slate-900 resize-none"
//                             />
//                           </div>

//                           <div className="grid grid-cols-2 gap-3">
//                             <div>
//                               <label className="block text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">City</label>
//                               <input
//                                 type="text"
//                                 required
//                                 value={addressCity}
...
//                             </div>
//                             <div>
//                               <label className="block text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">State</label>
//                               <input
//                                 type="text"
//                                 required
//                                 value={addressState}
...
//                               className="flex items-center gap-1.5 px-4 py-2.5 bg-slate-950 text-[#A7E22E] hover:bg-slate-900 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer shadow-md"
//                             >
//                               <Save className="h-4 w-4 shrink-0" />
...
//                                 className="px-4 py-2 border border-slate-200 text-slate-500 hover:text-slate-800 rounded-lg text-xs font-bold uppercase transition-colors cursor-pointer"
//                               >
//                                 Cancel
//                               </button>
//                             )}
...
//                           <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">SAVED ADDRESSES</span>
//                           <button
//                             type="button"
//                             onClick={() => {
//                               resetAddressForm();
        ...
        >
          ...
          <div className="w-full md:w-[280px] bg-white rounded-3xl border border-slate-100 p-4 md:p-6 flex flex-col justify-between shrink-0 shadow-2xl h-auto md:h-full relative overflow-y-auto md:overflow-visible">
            <div className="flex flex-col md:block">
              {/* Brand Logo inside Sidebar - Styled with Neon Green logo/text on dark slate background */}
              <div className="hidden md:flex mb-6 -mx-6 -mt-6 p-5 rounded-t-3xl bg-slate-950 border-b border-[#A7E22E]/20 justify-center shadow-md">
                <BalanzaLogo className="h-10 w-auto text-[#A7E22E]" showIcon={true} />
              </div>
