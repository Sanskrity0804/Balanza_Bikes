...
Submitted At: ${timestampString}`;
      ...
      return res.json({
        ...
        message: emailDeliverySuccess 
          ? "Form data successfully logged and notification email delivered."
          : `Inquiry registered successfully. (Note: Notification email delivery pending: ${deliveryErrorMessage})`
      });
